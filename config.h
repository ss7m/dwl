...
#define FF ((float) 0xFF)
#define HC(r,g,b) { 0x ## r / FF, 0x ## g / FF, 0x ## b / FF, 1.0}
static const float rootcolor[]      = HC(77, 77, 77);
static const float bordercolor[]    = HC(16, 18, 21);
static const float focuscolor[]     = HC(6B, 70, 89);
#undef HC
#undef FF
